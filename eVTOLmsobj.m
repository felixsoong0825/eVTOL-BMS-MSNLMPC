function [msobj,simdata] =  eVTOLmsobj(p,Ts,initialPose,targetPose,u0,params,costfun,costfunLast)
msobj = nlmpcMultistage(p,8,2);
msobj.Ts = Ts;
msobj.UseMVRate = true;

msobj.MV(1).Min = 0; msobj.MV(1).Max = 30000;     
...
msobj.States(2).Min = -5; msobj.States(2).Max =  30;
% msobj.States(3).Min = 0; msobj.States(3).Max = 30000;
% msobj.States(4).Min = 0; msobj.States(4).Max = 320;
% msobj.States(5).Min = 0.35; msobj.States(5).Max = 1;
